...
*
* - 초기 용량 및 부하율 :
* HashMap은 초기 용량을 설정할 수 있으며, 부하율(Load Factor)을 통해
* 리사이징 시점을 조절하게 되며, 부하율이 낮으면 충돌이 줄어들고 성능이 향상될 수 있다.
* 예) 0.75f의 부하율은 75%을 의미한다.
* 리사이징이란 현재의 배열에 크기를 늘리고 기존 요소를 복사하는 과정을 의미한다.
*
* - 결론 :
* HashMap은 빠른 데이터 접근과 유연한 키-값 쌍 관리를 제공하지만 해시 충돌과 메모리 사용량에 주의해야 한다.
...
public class MapDeep {
    public static void main(String[] args) {
        ...
        // 그렇다고 해서 너무 크게 지정하는 경우 메모리 낭비가 발생할 수 있으니 참고하자.
